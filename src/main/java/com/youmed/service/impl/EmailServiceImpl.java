...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendOtpEmail(String toEmail, String otp) {
        try {
            ...
            helper.setSubject("YouMed - Xác nhận đăng ký tài khoản");
    ...
    public void sendForgotPasswordEmail(String toEmail, String otp) {
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setTo(toEmail);
            helper.setSubject("YouMed - Lấy lại mật khẩu");
            ...
            throw new RuntimeException("Lỗi khi gửi email lấy lại mật khẩu: " + e.getMessage());
        }
    }
}
